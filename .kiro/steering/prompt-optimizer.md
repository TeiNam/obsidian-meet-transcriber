...
- User says "what's the best way to prompt for..."
- User says "优化prompt", "改进prompt", "怎么写prompt", "帮我优化这个指令"
- User pastes a draft prompt and asks for feedback or enhancement
- User says "I don't know how to prompt for this"
- User says "how should I use this harness for..."
...
- User is asking about harness configuration (use `configure-harness` instead)
...
|-----------|------------------|
| `configure-harness` | User hasn't set up the harness yet |
