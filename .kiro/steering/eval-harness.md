...
1. **Define** — Create an eval definition file before coding
2. **Implement** — Write code to pass the defined evals
3. **Check** — Run each eval, record PASS/FAIL
4. **Report** — Summarize results with pass@k metrics
...
### Phase 3: Evaluate
Run each eval against the implementation and record PASS/FAIL.
